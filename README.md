...
# 1. Hello Github
My name is Muhammad Fathur Nur Rizky. You can just call me Fathur(i'm web developer and Game Developer), i'm from surabaya(Indonesia). And i still student try to figure out fuc*ing messy code that i wrote of my self. Peace.
...
# 4. My Focus
Javascript and Python(i also want to learn about Game Development with C++).
